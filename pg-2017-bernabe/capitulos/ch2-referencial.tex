...
%TODO: acho legal um susubsection pra awreqs e evoreqs (separado), ai explica melhor, no caso de evoreqs, as applicabilities e resolution conditions, assim como as strategies e mostra um codigo de adaptação (verificar se é melhor colocar o codigo aqui ou na secao de exemplo).
%Awreqs
...
%TODO: acho que aqui seria legal colocar o código que mostra como faz uma determinada evolução e explicá-lo melhor.
...
%TODO: acho que aqui pode começar a explicar os modulos de monitoramento e adaptação, e aproveitara pra ja mostrar o metamodelo de classes original do zanshin, sem citar o meu novo lindo. Além disso, em algum lugar explicar ainda melhor os evoreqs, falando das conditions e checagem.
