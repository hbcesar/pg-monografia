...
\vitor{Nomes de seções e de figuras são considerados nomes próprios e, portanto, devem ter a primeira letra maiúscula.}
...
\vitor{MDD foi usado apenas produção automática de código? O desenvolvimento do Unagi entra nesta categoria? Ou talvez poderíamos incrementar a última frase acima?}
...
\vitor{Vai escrever sobre Acceleo também? Você usou Acceleo?}
