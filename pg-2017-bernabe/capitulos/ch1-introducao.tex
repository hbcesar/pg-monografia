...
\banca{Interessante a forma como explicitou essas duas limitações.
	Essas limitações são, na verdade, a motivação do trabalho, né? Talvez seja legal já indicar que essas limitações são a base da motivação. 
	Algo como "Este trabalho encontra-se no contexto da pesquisa em torno da abordagem Zanshin buscando melhorias/aperfeiçoamento/avançar em duas de suas limitações: [...]"}
\banca{Essas duas limitações são, inclusive, muito importantes de serem trabalhadas. Talvez seja legal aprofundar um pouquinho nelas. Por exemplo, que conjunto de modeos desejados são esses? Modelos do universo GORE? E também, dizer falar sobre uma ferramenta de fácil uso pode ajudar/incentivar o uso do Zansing pelos eng. requisitos.}
...
\banca{o que é metamodelo operacional do zanshin? É dito somente "baseada nesse metamodelo do Zanshin". Senti falta de dizer que é para ser utilizado pelo zanshin, que o modelo de sistemas criado pela ferramenta é para ser utilizado, importado, pelo Zanshin. É isso, né? }
...
\begin{itemize}
	...
	\banca{A ferramenta é o Unagi, certo? Acho válido dizer isto aqui.}
...
\vitor{Comentar a publicação do artigo CBSoft e citá-lo. Te falo depois como citar algo que está aceito mas não publicado ainda.}
