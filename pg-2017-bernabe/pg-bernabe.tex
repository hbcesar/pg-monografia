...
\newcommand{\banca}[1]{\todo[author=\textbf{Vítor},color=blue!30,caption={},inline]{#1}}


%%% Definição de variáveis. %%%

% (*) Substituir os textos abaixo com as informações apropriadas.
\titulo{Evolução da Arquitetura do Zanshin – um framework para análise de requisitos em tempo de execução e desenvolvimento da ferramenta CASE Unagi}
...
\newcommand{\acceleo}{Acceleo\texttrademark\xspace}
...
\newcommand{\novocodigoZanshin}{\url{https://github.com/hbcesar/zanshin}}
